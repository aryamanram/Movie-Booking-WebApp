...
const Navbar = () => {
    ...
    return (
        <div className = "fixed top-0 left-0 z-50 w-full flex items-center justify-between px-6 md:px-16 lg:px-36 py-5">
            ...
            z-50 flex flex-col md:flex-row items-center gap-8 backdrop-blur bg-black/70 md:bg-white/10 md:border border-gray-300/20
            min-md:px-8 py-3 min-md:rounded-full overflow-hidden transition-[width] duration-300 
